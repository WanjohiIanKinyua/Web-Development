...
<p style="text-align:center;font-size:40px;font-family:cursive;color:black;color: blue; border-radius:0.5px;margin-left:300px;margin-top:-362">Welcome Admin to emajent bloodbank</p>
...
<li><a href="bloodupdate.php" style="font-size:20px">Update Blood Details</a></li>
<li><a href="camps.html" style="font-size:20px">Update Camp Details</a></li>
<li><a href="viewrequest.php"style="font-size:20px">View Blood Requests</a></li>
<li><a href="viewdonations.php"style="font-size:20px">View Donations</a></li>
<li><a href="logout.php"style="font-size:20px">Logout</a></li>
</ul>

<center>
<img src="homepage1.png" alt="" height="300px" width="500px"><br><br><br><br><br>
